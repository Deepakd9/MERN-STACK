                ...
                return (
                    <div key={index} className='flex justify-center items-center py-10'>
                        <div className='pl-44 grow-[2]'>
                            <img className='h-[850px] rounded-lg'
                                src={item.img} alt={item.name} />

                        </div>
                        <div className='grow-[3]'>
                            <div className='max-w-lg'>
                                <h5 className='text-2x1 font-inter font-bold tracking-normal leading-none pb-4'>
                                    {item.name}
                                </h5>
                                ...
                                <div className='pb-4'>
                                    {item.size ? (<div>
                                        <label htmlFor="size" onChange={(e) => setSize(e.target.value)}
                                        ...
                                        <div>
                                            ...
                                            <select id='size' disabled={true} name='size' value={size} onChange={(e) => setSize(e.target.value)}
                                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                {item?.size?.map((item, index) => {
                                                    return (
                                                        <option key={index} value={item}>
                                ...
                                <div className='pb-4'>
                                    <label htmlFor="color" onChange={(e) => setColor(e.target.value)}
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Pick a color
                                    </label>
