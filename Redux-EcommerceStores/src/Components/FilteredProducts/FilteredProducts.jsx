...
import { filterProducts, filterGender, sortByPrice, filterByColor, filterBySize } from '../../features/slices/productsSlice'
        ...
        <div className=''>
            <div className='pt-16'>
                <div className='pl-14'>
                    ...
                    <div className='flex items-centr justify-between py-8'>
